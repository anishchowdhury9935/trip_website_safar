                    ...
                    <footer className='DownNavBar_main'>
                        <section id='DownNavBar_main_container'>
                            ...
                            <Link className='DownNavBar_btn'
                                ...
                                <Image width={27} height={27} className="DownNavBar_icon_img" src={clickedBtnInfo.btnName === "myTrip" ? myTripLogo_fill.src : myTripLogo_hollow.src} alt="" />
                            ...
                            <Link className='DownNavBar_btn'
                                ...
                                <Image width={27} height={27} className="DownNavBar_icon_img bell" src={clickedBtnInfo.btnName === "notification" ? notification_icon_fill.src : notification_icon_hollow.src} alt="" />
                            ...
                            <Link className='DownNavBar_btn'
                                ...
                                <Image width={27} height={27} className="DownNavBar_icon_img" src={clickedBtnInfo.btnName === "offer" ? offer_icon_fill.src : offerIcon_hollow.src} alt="" />
